    ...
    <div id="export-area" class="p-2 text-black bg-white">
        ...
        <div class="w-full max-w-4xl pt-4 mx-auto text-sm">
            ...
            <div class="flex items-center justify-center w-full gap-2 my-6">
                <span class="font-semibold text-center">WTC Name Tag/No: {{ $walkin->tag_no }}</span>
            </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="px-2 py-2 border border-black">
                            {{ $walkin->pic?->checkedBy?->name ?? '-' }}
                        </td>
                        <td class="px-2 py-2 border border-black">
                            {{ $walkin->pic?->approvedBy?->name ?? '-' }}
                        </td>
                    </tr>
                    <tr>
                        <td class="px-2 py-2 font-medium border border-black">Signature</td>
                        <td class="px-2 py-4 border border-black">
                            <img src="{{ asset('storage/' . $walkin->pic->checked_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                        <td class="px-2 py-4 border border-black">
                            <img src="{{ asset('storage/' . $walkin->pic->approved_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2 py-2 border border-black">
                            {{ $walkin->pic->checked_date }}
                        </td>
                        <td class="px-2 py-2 border border-black">
                            {{ $walkin->pic->approved_date }}
                        </td>
                        </td>
                    </tr>
                </tbody>
    ...
    function exportPDF() {
        ...
        function renderPDF() {
            html2pdf().set({
                ...
                filename: "walkin-chamber-maintenance.pdf",
                image: {
                    type: "jpeg",
                    quality: 1
                },
