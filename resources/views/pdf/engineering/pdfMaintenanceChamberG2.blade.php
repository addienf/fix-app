            ...
            <table class="w-full border border-black text-sm">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border border-black px-2 py-2">
                            {{ $G2->pic->approved_name }}
                        </td>
                    </tr>
                    <tr>
                        <td class="border border-black font-medium px-2 py-2">Signature</td>
                        <td class="border border-black px-2 py-4">
                            <img src="{{ asset('storage/' . $G2->pic->checked_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                        <td class="border border-black px-2 py-4">
                            <img src="{{ asset('storage/' . $G2->pic->approved_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                    </tr>
                    <tr>
    ...
    function exportPDF() {
        ...
        function renderPDF() {
            html2pdf().set({
                ...
                filename: "stability-chamber-g2-maintenance.pdf",
                image: {
                    type: "jpeg",
                    quality: 1
                },
