    ...
    <div id="export-area" class="p-2 bg-white text-black">
        ...
        <div class="w-full max-w-4xl pt-4 mx-auto text-sm">
            ...
            <div class="flex justify-center items-center gap-2 w-full my-6">
                <span class="text-center font-semibold">Name Tag/No: {{ $refrigerator->tag_no }}</span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-black px-2 py-4">
                            <img src="{{ asset('storage/' . $refrigerator->pic->checked_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                        <td class="border border-black px-2 py-4">
                            <img src="{{ asset('storage/' . $refrigerator->pic->approved_signature) }}" alt="Signature"
                                class="object-contain h-full" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-black px-2 py-2">
                            {{ $refrigerator->pic->checked_date }}
                        </td>
                        <td class="border border-black px-2 py-2">
                            {{ $refrigerator->pic->approved_date }}
                        </td>
                        </td>
                    </tr>
                </tbody>
    ...
    function exportPDF() {
        ...
        function renderPDF() {
            html2pdf().set({
                ...
                filename: "refrigerator-maintenance.pdf",
                image: {
                    type: "jpeg",
                    quality: 1
                },
