...
@section('content')
    ...
    $infoUmumFields = [
        ...
        ['label' => 'Perusahaan :', 'value' => $service->perusahaan],
                                ...
                                <div class="mb-3 space-y-2">
                                    <label>
                                        <input type="checkbox" name="deskripsi_pekerjaan[]" value="service" {{ in_array('service', $service->deskripsi_pekerjaan) ? 'checked' : '' }} disabled>
                                        Service
                                    </label><br>

                                    <label>
                                        <input type="checkbox" name="deskripsi_pekerjaan[]" value="maintenance" {{ in_array('maintenance', $service->deskripsi_pekerjaan) ? 'checked' : '' }} disabled>
                                        Maintenance
                                    </label><br>

                                    <label>
                                        <input type="checkbox" name="deskripsi_pekerjaan[]" value="lainya" {{ in_array('lainya', $service->deskripsi_pekerjaan) ? 'checked' : '' }} disabled>
                                        Lainnya
                                    </label>
                                </div>
                                ...
                                <table class="w-full mb-4 text-center border border-collapse border-black">
                                    <thead>
                                        <tr class="bg-gray-100">
                                            ...
                                            <th class="px-2 py-1 border border-black w-40">Nama Teknisi</th>
                                            <th class="px-2 py-1 border border-black w-40">Jabatan</th>
    ...
    $kondisi = $service->pemeriksaanPersetujuan->status_pekerjaan;
                                ...
                                <ol class="pl-5 mb-4 list-decimal">
                                    <li class="mb-2">
                                        ...
                                        <span class="ml-2">
                                            <input type="radio" name="selesai" value="Ya" {{ $kondisi === 'ya' ? 'checked' : '' }} disabled> Ya 
