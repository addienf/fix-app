...
@section('content')
        <div id="export-area" class="p-2 bg-white text-black">
            ...
            @php
    $fields = [
        ['label' => 'No SPK  :', 'value' => 'QC/SPK/017/VI/2025'],
        ['label' => 'No SPK MKT :', 'value' => 'MKT/SPK/045/VI/2025'],
        ['label' => 'Dari :', 'value' => 'Divisi QC'],
        ['label' => 'Kepada :', 'value' => 'Divisi Produksi'],
    ];
            @endphp
            ...
            <div class="w-full max-w-4xl mx-auto mt-6 overflow-x-auto text-sm">
                <table class="w-full text-sm text-left border border-gray-300 dark:border-gray-600">
                    ...
                    <tbody class="text-black bg-white dark:bg-gray-900 dark:text-white">
                        @foreach ([
        ['name' => 'Generator 5000W', 'quantity' => 12, 'urs' => 'URS/024/MKT/2025', 'tanggal' => '2025-07-01'],
        ['name' => 'Panel Kontrol Listrik', 'quantity' => 6, 'urs' => 'URS/024/MKT/2025', 'tanggal' => '2025-07-01'],
        ['name' => 'Pompa Industri XZ-10', 'quantity' => 3, 'urs' => 'URS/024/MKT/2025', 'tanggal' => '2025-07-01'],
    ] as $index => $item)
                            <tr>
                                <td class="px-4 py-2 border border-gray-300 dark:border-gray-600">{{ $index + 1 }}</td>
                                <td class="px-4 py-2 border border-gray-300 dark:border-gray-600">{{ $item['name'] }}</td>
                                ...
                                <td class="px-4 py-2 border border-gray-300 dark:border-gray-600">{{ \Carbon\Carbon::parse($item['tanggal'])->translatedFormat('d M Y') }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="max-w-4xl mx-auto mt-10 text-sm">
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <img src="{{ asset('storage/dummy-signature-create.png') }}" alt="Product Signature" class="h-20 w-80" />
                        <p class="mt-1 font-semibold dark:text-white">Divisi Marketing</p>
                        <p class="mt-1 font-semibold dark:text-white">Marketing</p>
                    </div>
                    <!-- Kanan -->
                    <div class="flex flex-col items-center">
                        <p class="mb-2 dark:text-white">Yang Menerima</p>
                        <img src="{{ asset('storage/dummy-signature-receive.png') }}" alt="Product Signature" class="h-20 w-80" />
                        <p class="mt-1 font-semibold dark:text-white">Divisi Produksi</p>
