    ...
    <div id="export-area" class="p-2 text-black bg-white ">
        ...
        <div class="max-w-4xl mx-auto mb-6 text-sm">
            ...
            <p class="flex flex-wrap items-center gap-1">
                <span>Berdasarkan SPK MKT No. {{ $permintaan_alat_bahan->jadwalProduksi->spk->no_spk }} mohon bantuan
                    untuk memenuhi
        ...
        @endphp
        <p class="w-full max-w-4xl pt-4 mx-auto ttd"> Terimakasih. </p>
        <div class="max-w-4xl pt-2 mx-auto text-sm ttd">
