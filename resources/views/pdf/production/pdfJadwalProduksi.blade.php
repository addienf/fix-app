...
@section('content')
    ...
    $infoUmum = [
        ...
        ['label' => 'SPK MKT:', 'value' => $jadwal->spk->no_spk],
                ...
                <div class="max-w-4xl pt-2 mx-auto mb-6 text-lg font-bold text-start">B. Identifikasi Produk</div>
                <div class="max-w-4xl mx-auto overflow-x-auto mb-3">
                ...
                <div class="max-w-4xl pt-2 mx-auto mb-6 text-lg font-bold text-start">C. Detail Jadwal Produksi</div>
                <div class="max-w-4xl mx-auto overflow-x-auto mb-3">
                    <table class="w-full text-sm text-left border border-gray-300 dark:border-gray-600">
                        <thead class="text-black bg-gray-100 dark:bg-gray-800 dark:text-white">
                            <tr>
                ...
                <div class="max-w-4xl pt-2 mx-auto mb-6 text-lg font-bold text-start">E. Kebutuhan Bahan/Alat</div>
                <div class="max-w-4xl pb-5 mx-auto overflow-x-auto mb-3">
                    <table class="w-full text-sm text-left border border-gray-300 dark:border-gray-600">
                        <thead class="text-black bg-gray-100 dark:bg-gray-800 dark:text-white">
                            <tr>
                                <th class="px-4 py-2 border">No</th>
