    ...
    <div id="export-area" class="p-2 bg-white text-black">
        ...
        @php
            $fields2 = [
                ...
                ['label' => '2. Kode Produk :', 'value' => 'INV-MTR-2025'],
                ['label' => '3. Nomor Batch/Seri :', 'value' => 'BATCH-3342'],
        ...
        <div class="grid w-full max-w-4xl grid-cols-1 pt-4 mx-auto mb-4 gap-y-4">
            ...
            <div class="pt-1">
                <label class="block mb-1 font-semibold">Jelaskan</label>
                <textarea readonly
                    class="w-full px-3 py-2 overflow-hidden text-sm leading-relaxed border rounded-md cursor-not-allowed resize-none border-black">{{ $detail_kondisi_fisik }}</textarea>
            </div>
            ...
            <div class="pt-1">
                ...
                <textarea readonly
                    class="w-full px-3 py-2 overflow-hidden text-sm leading-relaxed border rounded-md cursor-not-allowed resize-none border-black">{{ $detail_kelengkapan_komponen }}</textarea>
            </div>
            ...
            <h2 class="col-span-1 mb-2 text-xl font-bold text-start">C. Serah Terima</h2>
            ...
            <div class="mb-1">
                ...
                <div class="flex flex-col gap-1 pl-4">
                    ...
                    <div class="pt-1">
                        <label class="block mb-1 font-semibold">Jelaskan</label>
                        <textarea readonly
                            class="w-full px-3 py-2 overflow-hidden text-sm leading-relaxed border rounded-md cursor-not-allowed resize-none border-black">{{ $penjelasan_status }}</textarea>
                    </div>
                    <label class="inline-flex items-center gap-2">
