            ...
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <img src="{{ asset('storage/' . $produkJadi->pic->submit_signature) }}" alt="Product Signature"
                        class="h-20 w-80" />
                    <p class="mt-4 font-semibold dark:text-white">{{ $produkJadi->pic->submitName->name }}</p>
                </div>
                <!-- Kanan -->
                <div class="flex flex-col items-center">
                    ...
                    <img src="{{ asset('storage/' . $produkJadi->pic->receive_signature) }}" alt="Product Signature"
                        class="h-20 w-80" />
                    <p class="mt-4 font-semibold dark:text-white">{{ $produkJadi->pic->receiveName->name }}</p>
                </div>
            </div>
        </div>
    </div>
