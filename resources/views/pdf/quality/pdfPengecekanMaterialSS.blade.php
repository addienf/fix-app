    ...
    <div id="export-area" class="p-2 text-black bg-white">
        ...
        <div class="w-full max-w-4xl pt-4 mx-auto mb-6">
            ...
            <textarea id="note" readonly
                class="w-full px-3 py-2 overflow-hidden text-sm leading-relaxed border border-black rounded-md resize-none">{{ trim($pengecekanSS->note) }}</textarea>
        </div>
