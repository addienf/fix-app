        ...
        'Motor Pendingin 220V',
                ...
                <div class="w-full max-w-4xl mx-auto mb-6">
                    ...
                    <textarea id="note" name="note" rows="4"
                        class="w-full border border-black px-3 py-2 text-sm resize-none">Perlu pengecekan lebih lanjut pada pipa baja dan pompa tekanan rendah.</textarea>
                </div>
