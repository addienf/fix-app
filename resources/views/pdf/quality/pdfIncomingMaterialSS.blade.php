...
@section('content')
    <div id="export-area" class="p-2 bg-white text-black">
        ...
        <div class="w-full max-w-4xl pt-4 mx-auto space-y-4 text-sm">
            @php
                $fields = [
                    ['label' => 'No PO :', 'value' => 'PO-SS-2025-001'],
                    ['label' => 'Supplier  :', 'value' => 'PT. Baja Stainless Abadi'],
                ];
            @endphp
        ...
        @php
            $checklist = [
                'actual_result_1' => 'Tidak ada perubahan warna setelah 3 menit',
                'actual_result_2' => 'Permukaan bersih tanpa karat',
            ];

            $detailsTambahan = [
                [
                    'procedures' => 'Tes magnet pada permukaan',
                    'expected_result' => 'Tidak menempel kuat',
                    'actual_result_1' => 'Sedikit menempel tapi masih sesuai',
                ]
            ];
        @endphp

        <div class="max-w-4xl mx-auto pt-4 space-y-5 text-sm">
            <!-- Table 1: Inspection -->
                ...
                <table class="w-full text-left border-collapse table-fixed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-4 py-2 align-top border">
                                <ul class="pl-4 list-disc">
                                    ...
                                    <li>Make a mark on the upper, middle and bottom side of the material surface</li>
                                    <li>Drop the testing liquid and wait about 2–3 minutes</li>
                                </ul>
                            </td>
                            <td class="px-4 py-2 align-top border">
                                There was no color change within 3 minutes after the liquid dropped
                            </td>
                            <td class="px-4 py-2 align-top border">
                                <textarea
                                    class="w-full h-24 px-2 py-1 border rounded-md resize-none">Tidak ada perubahan warna setelah 3 menit</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border">No Defect and rust found</td>
                            <td class="px-4 py-2 border">
                                <textarea
                                    class="w-full h-20 px-2 py-1 border rounded-md resize-none">Permukaan bersih tanpa karat</textarea>
                            </td>
                        </tr>
                        ...
                        @foreach ($detailsTambahan as $item)
                            <tr>
                                <td class="px-4 py-2 border">{{ $item['procedures'] }}</td>
                                <td class="px-4 py-2 border">{{ $item['expected_result'] }}</td>
                                <td class="px-4 py-2 border">
                                    <textarea
                                        class="w-full h-20 px-2 py-1 border rounded-md resize-none">{{ $item['actual_result_1'] }}</textarea>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <table class="w-full text-sm text-left border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border">97</td>
                        </tr>
                        <tr>
            ...
            <div class="w-full max-w-4xl mx-auto mb-6">
                ...
                <div id="note" readonly
                    ...
                    Permukaan logam sudah sesuai standar pengujian SS304.
                </div>
            </div>
