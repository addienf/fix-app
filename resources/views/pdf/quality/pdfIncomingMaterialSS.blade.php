...
@section('content')
    <div id="export-area" class="p-2 text-black bg-white">
        <table
            ...
            <tr>
                <td class="font-bold text-center border border-black dark:border-white dark:bg-gray-900"
                    ...
                    Formulir Incoming Stainless <br> Steel Materials Quality Check
                </td>
        ...
        <div class="w-full max-w-4xl pt-4 mx-auto space-y-5 text-sm">
            @php
                $fields = [
                    ['label' => 'No QC SS :', 'value' => $incomingSS->no_qc],
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 border">
                                    <textarea class="w-full h-20 px-2 py-1 border rounded-md resize-none focus:outline-none focus:ring focus:ring-gray-300">{{ $checklist['actual_result_2'] ?? '-' }}</textarea>
                                </td>
                            </tr>
                            @foreach ($detailsTambahan as $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 align-top border">
                                        <textarea class="w-full h-20 px-2 py-1 border rounded-md resize-none focus:outline-none focus:ring focus:ring-gray-300">{{ $item['actual_result_1'] ?? '-' }}</textarea>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <table class="w-full text-sm text-left border-collapse">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-2 border">{{ $incomingSS->summary['summary']['total_received'] ?? '-' }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border">{{ $incomingSS->summary['summary']['total_rejected'] ?? '-' }}
                            </td>
                        </tr>
                        <tr>
