                                ...
                                @foreach ($detail->specification_mecmesin ?? [] as $spec)
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="flex items-center">
                                            <label class="w-32 font-medium">Sample:</label>
                                            <div class="flex-1 p-1 border rounded">{{ $spec['sample'] ?? '-' }}</div>
                                        </div>

                                        <div class="flex items-center">
                                            <label class="w-32 font-medium">Capacity:</label>
                                            <div class="flex-1 p-1 border rounded">{{ $spec['capacity'] ?? '-' }}</div>
                                        </div>

                                        <div class="flex items-center">
                                            <label class="w-32 font-medium">Jenis Tes:</label>
                                            <div class="flex-1 p-1 border rounded">{{ ucfirst($spec['jenis_tes'] ?? '-') }}
                                            </div>
                                        </div>

                                        <div class="flex items-center">
                                            <label class="w-32 font-medium">Test Type:</label>
                                            <div class="flex-1 p-1 border rounded">{{ ucfirst($spec['test_type'] ?? '-') }}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
