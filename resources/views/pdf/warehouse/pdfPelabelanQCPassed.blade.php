...
@section('content')
    ...
    $fields = [
        ...
        ['label' => 'Penanggung Jawab :', 'value' => 'Andi Wijaya'],
    ];
                        @endphp
    ...
    $details = [
        ...
        [
            ...
            'tipe' => 'Model-Z2',
            'serial_number' => 'SN002-B',
            'jenis_transaksi' => 'Keluar',
            'jumlah' => 4,
            'keterangan' => 'Dikirim ke pelanggan',
        ],
    ];
                        @endphp
                    ...
                    <div class="w-full max-w-4xl pt-4 mx-auto space-y-2 text-sm">
                        @php
    $fields = [
        ['label' => 'Total Produk Masuk :', 'value' => '10 Buah'],
        ['label' => 'Total Produk Keluar :', 'value' => '4 Buah'],
        ['label' => 'Sisa Stock :', 'value' => '6 Buah'],
    ];
                        @endphp
                ...
                <div class="max-w-4xl mx-auto mt-10 text-sm">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <img src="{{ asset('asset/tanda-tangan-dummy1.png') }}" alt="Product Signature" class="h-20 w-80" />
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <img src="{{ asset('asset/tanda-tangan-dummy2.png') }}" alt="Product Signature" class="h-20 w-80" />
                            <p class="mt-1 font-semibold dark:text-white">Siti Rahmawati</p>
