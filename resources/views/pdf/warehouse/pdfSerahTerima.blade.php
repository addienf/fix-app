...
@section('content')
    <div id="export-area" class="p-2 bg-white text-black">
        ...
        @php
    $fields = [
        ['label' => 'Nomor:', 'value' => 'ST-001/PRD/2025'],
...
<div class="max-w-4xl mx-auto overflow-x-auto">
    <table class="w-full text-sm text-left border border-gray-300 dark:border-gray-600">
        ...
        <tbody class="bg-white dark:bg-gray-900">
            @foreach ([
                ['bahan_baku' => 'Bearing 6202', 'spesifikasi' => 'Metal Sealed', 'jumlah' => '20 pcs', 'keperluan_barang' => 'Perawatan Mesin Produksi'],
                ['bahan_baku' => 'Grease SKF', 'spesifikasi' => 'Hi-Temp', 'jumlah' => '5 tube', 'keperluan_barang' => 'Pelumasan Komponen'],
            ] as $index => $produk)
                <tr>
...
<div class="max-w-4xl mx-auto mt-10 text-sm">
    <div class="flex items-start justify-between gap-4">
        <div class="flex flex-col items-center">
            ...
            <img src="{{ asset('storage/dummy-signature-1.png') }}" alt="Signature"
        ...
        <div class="flex flex-col items-center">
            ...
            <img src="{{ asset('storage/dummy-signature-2.png') }}" alt="Signature"
                class="object-contain h-20 w-80" />
            <div class="mt-2 font-medium dark:text-white">
                Rina Aprilianti
            </div>
