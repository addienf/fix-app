...
@section('content')
        <div id="export-area" class="p-2 bg-white text-black">
            ...
            <div class="w-full max-w-4xl pt-4 mx-auto space-y-2 text-sm">
                @php
    $fields = [
        ['label' => 'Nomor :', 'value' => 'PB-2025-00123'],
        ['label' => 'Tanggal Penerimaan :', 'value' => '19 Juni 2025'],
    ];
                @endphp
    ...
    $materials = [
        [
            'nama_material' => 'Zat Aktif A',
            'batch_no' => 'BA123456',
            'jumlah' => 25,
            'satuan' => 'Kg',
            'kondisi_material' => 'Baik',
            'status_qc' => 1,
        ],
        [
            'nama_material' => 'Bahan Pelarut B',
            'batch_no' => 'BP654321',
            'jumlah' => 50,
            'satuan' => 'Liter',
            'kondisi_material' => 'Tidak Baik',
            'status_qc' => 0,
        ],
    ];
                        @endphp
            ...
            <div class="max-w-4xl mx-auto mt-10 text-sm">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex flex-col items-center">
                        ...
                        <img src="{{ asset('asset/signature-dummy-a.png') }}" alt="Signature" class="h-20 w-80" />
                        <p class="mt-4 font-semibold dark:text-white">Budi Santoso</p>
                    </div>
                    <div class="flex flex-col items-center">
                        <p class="mb-2 dark:text-white">Diterima Oleh</p>
                        <img src="{{ asset('asset/signature-dummy-b.png') }}" alt="Signature" class="h-20 w-80" />
                        <p class="mt-4 font-semibold dark:text-white">Siti Nurhaliza</p>
                    </div>
                </div>
            </div>
        </div>
