...
$fields2 = [
    ...
    ['label' => '4. Tanggal Produksi Mekanik Selesai:', 'value' => \Carbon\Carbon::now()->format('d M Y')],
    ['label' => '5. Jumlah Unit :', 'value' => '10'],
        ...
        @foreach ($fields2 as $field)
            <div class="flex items-center gap-4">
                <label class="w-72 font-medium">{{ $field['label'] }}</label>
        ...
        <div class="flex items-start gap-2">
            ...
            <div class="flex flex-col gap-1">
                <label class="inline-flex items-center gap-2">
                    <input type="checkbox" disabled checked class="form-checkbox text-blue-600" />
                    <span>Baik</span>
                </label>
                <label class="inline-flex items-center gap-2">
                    <input type="checkbox" disabled class="form-checkbox text-blue-600" />
        ...
        <div class="mb-1">
            <label class="block font-medium mb-2">1. Kondisi Fisik Produk</label>
        ...
        <div class="mb-1">
            <label class="block font-medium mb-2">2. Kelengkapan Dokumen</label>
        ...
        <div class="mb-1">
            <label class="block font-medium mb-2">3. Dokumen Pendukung</label>
...
$fields2 = [
    ...
    ['label' => 'Catatan Tambahan :', 'value' => 'DOC-456789'],
        ...
        @endforeach
        <div class="mb-1">
            <label class="block font-medium mb-2">Status Penerimaan</label>
            ...
            <div class="flex flex-col gap-1 pl-4">
                ...
                <div class="w-full px-3 py-2 text-sm text-gray-500 bg-white border border-gray-300 rounded-md cursor-not-allowed">
                    Jelaskan:          
                </div>
                <label class="inline-flex items-center gap-2">
                    <input type="checkbox" />
...
$roles = [
    ...
    'Diketehui Oleh' => [],
        ...
        @endphp
            ...
            <p> Catatan: Formulir ini harus diisi dengan lengkap sebelum produk diserahkan ke divisi berikutnya. Jika ada kendala, harap segera
