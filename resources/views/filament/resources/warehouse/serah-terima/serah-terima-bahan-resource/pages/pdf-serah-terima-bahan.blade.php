<x-filament-panels::page>
    ...
    @php
$fields = [
    ['label' => 'Nomor:', 'value' => 'SPK-MKT-001'],
    [
        'label' => 'Tanggal :',
        'value' => \Carbon\Carbon::parse('2025-06-02')->translatedFormat('d F Y'),
    ],
    ['label' => 'Dari :', 'value' => 'PT. Sumber Sejahtera'],
    ['label' => 'Kepada :', 'value' => 'Produksi'],
];
    @endphp
    ...
    <div class="max-w-4xl mx-auto mb-6 text-sm">
        ...
        <p class="flex flex-wrap items-center gap-1">
            ...
            <input type="disabled"
                class="w-32 px-2 py-1 text-sm align-middle bg-transparent rounded outline-none h-7 focus:outline-none"
                value=" " />
            <span>mohon bantuan untuk memenuhi kebutuhan bahan untuk sparepart dengan rincian sebagai berikut:</span>
        </p>
    </div>
    @php
$dummyDetails = [
    [
        ...
        'spesifikasi' => 'Kemasan 50kg, Merek ABC',
        'jumlah' => '100 kg',
        'keperluan_barang' => 'Produksi Sirup',
    ],
    [
        'bahan_baku' => 'Botol Plastik',
        'spesifikasi' => '1 Liter, Transparan',
        'jumlah' => '500 pcs',
        'keperluan_barang' => 'Pengemasan Produk',
    ],
    [
        'bahan_baku' => 'Label Produk',
        'spesifikasi' => 'Full Color, Waterproof',
        'jumlah' => '500 pcs',
        'keperluan_barang' => 'Branding',
    ],
];

$dummyPIC = [
    'create_signature' => 'signatures/dummy_signature.png',
    'create_name' => 'Andi Wijaya',
];
    @endphp
