            ...
            ->schema([
                                ...
                                Grid::make([
                                    ...
                                    ->schema([
                                        ...
                                        self::signatureInput(
                                            "checked_signature",
                                            '',
                                            'Engineering/Maintenance/RissingPipette/Signature'
                                        )
                                            ->required(false)
                                            ->columnSpanFull(),
                                    ])
                ...
                Section::make('Pelanggan')
                    ...
                    ->schema([
                        ...
                        self::signatureInput('approved_signature_draw', '', 'Engineering/Maintenance/RissingPipette/Signature')
                            ->visible(fn($get) => $get('ttd_method') === 'draw'),

                        FileUpload::make('approved_signature_upload')
                            ->label('Upload Scan Tanda Tangan')
                            ->image()
                            ->directory('Engineering/Maintenance/RissingPipette/Signature')
