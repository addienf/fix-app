...
use App\Filament\Resources\Engineering\Maintenance\RissingPipette\RissingPipetteResource\RelationManagers;
    ...
    protected static function signatureInput(string $fieldName, string $labelName): SignaturePad
    {
        return
            ...
            ->afterStateUpdated(function ($state, $set) use ($fieldName) {
                if (blank($state))
                    return;
                $path = SignatureUploader::handle($state, 'ttd_', 'Engineering/Maintenance/RissingPipette/Signature');
                if ($path) {
                    $set($fieldName, $path);
                }
            });
