...
namespace App\Policies\Engineering\Berita;
...
class BeritaAcaraPolicy
{
    ...
    {
        return $user->can('view_any_engineering::berita::berita::acara');
    }
    ...
    {
        return $user->can('view_engineering::berita::berita::acara');
    }
    ...
    {
        return $user->can('create_engineering::berita::berita::acara');
    }
    ...
    {
        return $user->can('update_engineering::berita::berita::acara');
    }
    ...
    {
        return $user->can('delete_engineering::berita::berita::acara');
    }
    ...
    {
        return $user->can('delete_any_engineering::berita::berita::acara');
    }
