...
namespace App\Policies\Warehouse\Pelabelan;

use App\Models\User;
use App\Models\Warehouse\Pelabelan\QCPassed;
use Illuminate\Auth\Access\HandlesAuthorization;

class QCPassedPolicy
{
    ...
    {
        return $user->can('view_any_warehouse::pelabelan::q::c::passed');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, QCPassed $qCPassed): bool
    {
        return $user->can('view_warehouse::pelabelan::q::c::passed');
    }
    ...
    {
        return $user->can('create_warehouse::pelabelan::q::c::passed');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, QCPassed $qCPassed): bool
    {
        return $user->can('update_warehouse::pelabelan::q::c::passed');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, QCPassed $qCPassed): bool
    {
        return $user->can('delete_warehouse::pelabelan::q::c::passed');
    }
    ...
    {
        return $user->can('delete_any_warehouse::pelabelan::q::c::passed');
    }
