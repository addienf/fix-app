...
return [
    [
        ...
        'parts' => [
            ['text' => 'Measure the current of cooling system (compresor)', 'show' => false],
    ...
    [
        ...
        'parts' => [
            ['info' => 'Take the screenshot/photo of logging data'],
    ...
    [
        ...
        'parts' => [
            ['info' => 'Check all the individual alarm by triggering each of them'],
            ...
            ['text' => 'Check all the alarm lamp', 'show' => false],
            ['text' => 'Check all the alarm buzzer', 'show' => false],
